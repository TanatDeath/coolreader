...
public class TTSOption extends SubmenuOption {
	...
	public void whenSelect() {
		...
		mOptionsDialog.mTTSUseDocLangOption = OptionsDialog.getOption(Settings.PROP_APP_TTS_USE_DOC_LANG, this.lastFilteredValue);
		...
		listView.add(OptionsDialog.getOption(Settings.PROP_PAGE_VIEW_MODE_TTS_DONT_CHANGE, this.lastFilteredValue));
