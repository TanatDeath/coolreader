...
public class RareOption extends SubmenuOption {
	...
	public void onSelect() {
		...
		OptionBase srO = new SkippedResOption(mActivity, mOptionsDialog.getContext(),
		...
		listView.add(srO);
		listView.add(new BoolOption(mActivity, mOwner, mActivity.getString(R.string.options_app_tapzone_hilite), Settings.PROP_APP_TAP_ZONE_HILIGHT,
		...
		if (!DeviceInfo.isEinkScreen(BaseActivity.getScreenForceEink()))
			listView.add(new BoolOption(mActivity, mOwner, mActivity.getString(R.string.options_app_trackball_disable), Settings.PROP_APP_TRACKBALL_DISABLED,
		...
		listView.add(new BoolOption(mActivity, mOwner, mActivity.getString(R.string.options_app_hide_state_dialogs), Settings.PROP_APP_HIDE_STATE_DIALOGS,
		...
		listView.add(new BoolOption(mActivity, mOwner, mActivity.getString(R.string.options_app_hide_css_warning), Settings.PROP_APP_HIDE_CSS_WARNING,
		...
		listView.add(new BoolOption(mActivity, mOwner, mActivity.getString(R.string.options_app_disable_safe_mode), Settings.PROP_APP_DISABLE_SAFE_MODE,
		...
		listView.add(new BoolOption(mActivity, mOwner, mActivity.getString(R.string.simple_font_select_dialog), Settings.PROP_APP_USE_SIMPLE_FONT_SELECT_DIALOG,
		...
		listView.add(new IconsBoolOption(mActivity, mOptionsDialog, mOwner,
		...
		if (!DeviceInfo.isEinkScreen(BaseActivity.getScreenForceEink())) {
			listView.add(new BoolOption(mActivity, mOwner, mActivity.getString(R.string.options_app_settings_icons_is_custom_color), Settings.PROP_APP_ICONS_IS_CUSTOM_COLOR,
					mActivity.getString(R.string.option_add_info_empty_text), this.lastFilteredValue).setDefaultValue("0").setIconIdByAttr(R.attr.attr_icons8_paint_palette1, R.drawable.icons8_paint_palette1));
			listView.add(new ColorOption(mActivity, mOwner, mActivity.getString(R.string.options_app_settings_icons_custom_color), Settings.PROP_APP_ICONS_CUSTOM_COLOR, 0x000000,
					mActivity.getString(R.string.option_add_info_empty_text), this.lastFilteredValue).setIconIdByAttr(R.attr.attr_icons8_paint_palette1, R.drawable.icons8_paint_palette1));
		}
