...
public class PageMarginsOption extends SubmenuOption {
	...
	public void onSelect() {
		...
		listView.add(new ListOption(mOwner, mActivity.getString(R.string.options_page_margin_left), Settings.PROP_PAGE_MARGIN_LEFT,
		...
		listView.add(new ListOption(mOwner, mActivity.getString(R.string.options_page_margin_right), Settings.PROP_PAGE_MARGIN_RIGHT,
				mActivity.getString(R.string.option_add_info_empty_text), this.lastFilteredValue).add(mMargins).setDefaultValue("5").
				setIconIdByAttr(R.attr.cr3_option_text_margin_right_drawable, R.drawable.cr3_option_text_margin_right));
		listView.add(new ListOption(mOwner, mActivity.getString(R.string.options_page_margin_top), Settings.PROP_PAGE_MARGIN_TOP,
				mActivity.getString(R.string.option_add_info_empty_text), this.lastFilteredValue).add(mMargins).setDefaultValue("5").
				setIconIdByAttr(R.attr.cr3_option_text_margin_top_drawable, R.drawable.cr3_option_text_margin_top));
		listView.add(new ListOption(mOwner, mActivity.getString(R.string.options_page_margin_bottom), Settings.PROP_PAGE_MARGIN_BOTTOM,
				mActivity.getString(R.string.option_add_info_empty_text), this.lastFilteredValue).add(mMargins).setDefaultValue("5").
