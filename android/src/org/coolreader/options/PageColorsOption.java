...
public class PageColorsOption extends SubmenuOption {
	...
	public void onSelect() {
		...
		listView.add(new NightModeOption(mActivity, mOwner, mActivity.getString(R.string.options_inverse_view), Settings.PROP_NIGHT_MODE,
		...
		mOptionsDialog.mTitleBarFontColor2 = new ColorOption(mActivity, mOwner,
		...
		listView.add(new ColorOption(mActivity, mOwner, mActivity.getString(R.string.options_color_text), Settings.PROP_FONT_COLOR, 0x000000,
		...
		listView.add(new ColorOption(mActivity, mOwner, mActivity.getString(R.string.options_color_background), Settings.PROP_BACKGROUND_COLOR, 0xFFFFFF,
		...
		if (!DeviceInfo.isEinkScreen(BaseActivity.getScreenForceEink())) {
			listView.add(new ColorOption(mActivity, mOwner, mActivity.getString(R.string.options_view_color_selection), Settings.PROP_HIGHLIGHT_SELECTION_COLOR,
					0xCCCCCC, mActivity.getString(R.string.option_add_info_empty_text), this.lastFilteredValue).noIcon());
			listView.add(new ColorOption(mActivity, mOwner, mActivity.getString(R.string.options_view_color_bookmark_comment), Settings.PROP_HIGHLIGHT_BOOKMARK_COLOR_COMMENT,
