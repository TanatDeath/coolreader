...
public class DictionaryOption extends SubmenuOption {
	...
	public DictionaryOption(BaseActivity activity, OptionsDialog od, OptionOwner owner, String label, String addInfo, String filter ) {
	...
	public void onSelect() {
		...
		listView.add(new DictOptions(mOwner, mActivity.getString(R.string.options_app_dictionary), Settings.PROP_APP_DICTIONARY,
		...
		listView.add(new DictOptions(mOwner, mActivity.getString(R.string.options_app_dictionary2), Settings.PROP_APP_DICTIONARY_2,
		...
		listView.add(new DictOptions(mOwner, mActivity.getString(R.string.options_app_dictionary)+" 3", Settings.PROP_APP_DICTIONARY_3,
				mActivity.getString(R.string.options_app_dictionary3_add_info), this.lastFilteredValue).
				setIconIdByAttr(R.attr.attr_icons8_google_translate_2, R.drawable.icons8_google_translate_2));
		listView.add(new DictOptions(mOwner, mActivity.getString(R.string.options_app_dictionary)+" 4", Settings.PROP_APP_DICTIONARY_4,
				mActivity.getString(R.string.options_app_dictionary3_add_info), this.lastFilteredValue).
				setIconIdByAttr(R.attr.attr_icons8_google_translate_2, R.drawable.icons8_google_translate_2));
		listView.add(new DictOptions(mOwner, mActivity.getString(R.string.options_app_dictionary)+" 5", Settings.PROP_APP_DICTIONARY_5,
				mActivity.getString(R.string.options_app_dictionary3_add_info), this.lastFilteredValue).
				setIconIdByAttr(R.attr.attr_icons8_google_translate_2, R.drawable.icons8_google_translate_2));
		listView.add(new DictOptions(mOwner, mActivity.getString(R.string.options_app_dictionary)+" 6", Settings.PROP_APP_DICTIONARY_6,
				mActivity.getString(R.string.options_app_dictionary3_add_info), this.lastFilteredValue).
				setIconIdByAttr(R.attr.attr_icons8_google_translate_2, R.drawable.icons8_google_translate_2));
		listView.add(new DictOptions(mOwner, mActivity.getString(R.string.options_app_dictionary)+" 7", Settings.PROP_APP_DICTIONARY_7,
				mActivity.getString(R.string.options_app_dictionary3_add_info), this.lastFilteredValue).
				setIconIdByAttr(R.attr.attr_icons8_google_translate_2, R.drawable.icons8_google_translate_2));
				...
				view -> {
					...
					AskSomeValuesDialog dlgA = new AskSomeValuesDialog(
						...
						if (results != null) {
							...
							mProperties.setProperty(Settings.PROP_APP_QUICK_TRANSLATION_DIRS, res.substring(1));
						}
					});
					dlgA.show();
				}, false).
				...
				view -> {
					...
					AskSomeValuesDialog dlgA = new AskSomeValuesDialog(
						...
						if (results != null) {
							String res = "";
							for (String s: results) res = res + ";" + s;
							mProperties.setProperty(Settings.PROP_APP_ONLINE_OFFLINE_DICS, res.substring(1));
						}
					});
					dlgA.show();
				}, false).
