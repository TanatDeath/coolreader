...
//	}
	...
	public final static ReaderAction ADD_OPDS_CATALOG = new ReaderAction("ADD_OPDS_CATALOG", 0, R.string.add_opds_catalog, ReaderCommand.DCMD_ADD_OPDS_CATALOG, 1, 0, null, R.string.option_add_info_empty_text).setIconId(R.drawable.icons8_opds);
	public final static ReaderAction ADD_REMOVE_LITRES_CATALOG = new ReaderAction("ADD_REMOVE_LITRES_CATALOG", 0, R.string.add_remove_litres_catalog, ReaderCommand.DCMD_ADD_REMOVE_LITRES_CATALOG, 1, 0,null, R.string.option_add_info_empty_text).setIconId(R.drawable.icons8_litres_en_logo_2lines_big);
	public final static ReaderAction ADD_CALIBRE_CATALOG_LOCAL = new ReaderAction("ADD_CALIBRE_CATALOG_LOCAL", 0, R.string.add_calibre_catalog_local, ReaderCommand.DCMD_ADD_CALIBRE_CATALOG_LOCAL, 1, 0,null, R.string.option_add_info_empty_text).setIconId(R.drawable.icons8_calibre);
	public final static ReaderAction ADD_CALIBRE_CATALOG_YD = new ReaderAction("ADD_CALIBRE_CATALOG_YD", 0, R.string.add_calibre_catalog_yd, ReaderCommand.DCMD_ADD_CALIBRE_CATALOG_YD, 1, 0, null, R.string.option_add_info_empty_text).setIconId(R.drawable.icons8_calibre);
