...
public class GoogleDriveToolsActivity extends Activity {
    ...
    GoogleDriveToolsActivity (Context context) {
        this.context = context;
        //mGoogleSignInClient = buildGoogleSignInClient();
        //getGoogleAccount();
    }

    private static final String TAG = "GoogleDriveToolsAct";
    ...
    private GoogleSignInClient buildGoogleSignInClient2() {
        ...
        //} else {
            GoogleSignInOptions signInOptions =
                    new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                            ...
                            .build();
            //GoogleSignInClient googleSignInClient = GoogleSignIn.getClient(this.context, signInOptions);
            //mGoogleSignInClient = GoogleSignIn.getClient(this.context, signInOptions);
            //signInAccount = GoogleSignIn.getLastSignedInAccount(this.context);
            //mDriveClient = Drive.getDriveClient(this.context, signInAccount);
            //mDriveResourceClient = Drive.getDriveResourceClient(this.context, signInAccount);
    ...
    public void getGoogleAccount() {
        ((CoolReader)context).showToast("gAcc");
        mSignInAccount = null;
        Task<GoogleSignInAccount> task = mGoogleSignInClient.
                silentSignIn();
            ...
            task.addOnCompleteListener(new OnCompleteListener<GoogleSignInAccount>() {
                ...
                public void onComplete(Task<GoogleSignInAccount> task) {
                    try {
                        ...
                        ((CoolReader)context).showToast("onComplete");
                        GoogleSignInAccount signInAccount = task.getResult(ApiException.class);
                        mSignInAccount = signInAccount;
                        createFile();
                        //updateViewWithAccount(account);
                    } catch (ApiException apiException) {
                        ((CoolReader)context).showToast("apiException");
