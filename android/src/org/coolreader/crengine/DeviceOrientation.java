...
public class DeviceOrientation {
    public static int ORIENTATION_PORTRAIT = ExifInterface.ORIENTATION_ROTATE_90; // 6
    public static int ORIENTATION_LANDSCAPE_REVERSE = ExifInterface.ORIENTATION_ROTATE_180; // 3
    public static int ORIENTATION_LANDSCAPE = ExifInterface.ORIENTATION_NORMAL; // 1
    public static int ORIENTATION_PORTRAIT_REVERSE = ExifInterface.ORIENTATION_ROTATE_270; // 8
