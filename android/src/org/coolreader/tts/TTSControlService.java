...
public class TTSControlService extends BaseService {
	...
	public void onCreate() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			...
			mMediaSession = new MediaSession(this, "KnownReader TTS");
			if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
	...
	private Notification buildNotification(String utterance) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
				...
				if (!mChannelCreated) {
					NotificationChannel channel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, CoolReader.READ_ALOUD, NotificationManager.IMPORTANCE_DEFAULT);
					channel.setDescription(CoolReader.READ_ALOUD);
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
				...
				if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT_WATCH) {
					...
					actionBld = new Notification.Action.Builder(R.drawable.icons8_fast_forward, "", nextIntent);
					...
					actionBld = new Notification.Action.Builder(R.drawable.icons8_stop, "", stopIntent);
			...
			notification = new Notification(R.drawable.known_reader_flogo, "KnownReader", System.currentTimeMillis());
