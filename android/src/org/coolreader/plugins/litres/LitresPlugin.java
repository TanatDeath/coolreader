...
public class LitresPlugin implements OnlineStorePlugin {
	...
	private void addBookFileInfo(final FileInfo dir, OnlineStoreBook book) {
		...
		fileInfo.setAuthorsLFM(book.getAuthors());
