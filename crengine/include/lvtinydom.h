...
lString32 extractDocGenre( ldomDocument * doc, lString32 delimiter=lString32::empty_str );
...
lString32 extractDocPublishSeries( ldomDocument * doc, int * pSeriesNumber=NULL );
